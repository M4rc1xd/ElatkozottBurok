...
namespace ElatkozottBurok.Tesztek
{
    ...
    public class IrodaTesztek
    {
        ...
        {
            var dev = new Fejleszto("Teszt Elek", Munkakor.Junior, 1000, "K�v�", 50, 20);

            dev.Koffeinszint = 120;
            Assert.That(dev.Koffeinszint, Is.EqualTo(100));
            Assert.That(dev.Kiegve, Is.True);

            var dev2 = new Fejleszto("Teszt Anna", Munkakor.Senior, 1000, "K�v�", 50, 20);
        ...
        {
            var dev = new Fejleszto("M�rk", Munkakor.Junior, 1000, "Maci Laci", 30, 50);
            var kedvenc = new Nassolnivalo("Maci Laci", 10, 10, 200);

            dev.Fogyaszt(kedvenc);

            // Koffein: 30 + 10 + 5 (b�nusz) = 45
            // Stressz: 50 - (10 * 2) = 30
        ...
        public void Automata_ElakadvaAllapotban_MegnoveliAVasarloStresszet()
        {
            ...
            var dev = new Fejleszto("P�ter", Munkakor.Senior, 1000, "K�v�", 50, 20);

            var kapott = automata.Vasarlas("K�v�", dev);
        ...
        public void Automata_KevesPenz_NemAdKiTermeket()
        {
            ...
            automata.Feltolt(new List<Nassolnivalo> { new Nassolnivalo("K�v�", 20, 10, 300) });
            var dev = new Fejleszto("Szeg�ny B�la", Munkakor.Junior, 100, "K�v�");
